...
const Practice2 = () => {
  ...
  return <div onClick={handleClick} className="h-full w-full bg-green-200 ">
    <div className="flex gap-10 p-5 ">
      <Button size="lg" onClick={handleUndo}>Undo</Button>
      <Button size="lg" onClick={handleRedo}>Redo</Button>
    </div>
